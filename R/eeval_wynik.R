#' Wynik obliczen emisji dla przykladowego pliku input
#'
#' Obiekt ten stanowi przykladowe dane wejsciowe dla funkcji eeval_draw().
#'
...
#'  \item{Nat}{Natezenie ruchu - wygenerowany losowo wektor o zadanej dlugosci}
